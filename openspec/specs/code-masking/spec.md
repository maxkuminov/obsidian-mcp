# code-masking Specification

## Purpose
The shared fence-recognition grammar and code masker consumed by heading resolution (section addressing and outlines), wikilink/markdown-link extraction, inline tag extraction, `move_note` link rewriting, and embedding cleaning — exactly which spans count as code, and the frontmatter boundary rule. Introduced by change fence-grammar-150 (issue #150).
