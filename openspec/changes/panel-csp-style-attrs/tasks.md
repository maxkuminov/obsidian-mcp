...
- [ ] 5.4 **Computed-style and geometry diff (D9)** of the same seed on `f3ecba5` and on the merged branch, both under `PANEL_CSP=off`, over every page × {light, dark} × {1280, 390}.
