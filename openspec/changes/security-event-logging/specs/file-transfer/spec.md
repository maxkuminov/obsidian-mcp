...
#### Scenario: The accepted path pays nothing

- **WHEN** a redemption succeeds
- **THEN** no diagnosis read SHALL be issued and no refusal record SHALL be emitted
