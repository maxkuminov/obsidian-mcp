...
- [x] 5.2 `openspec validate frontmatter-round-trip-128 --strict` clean.
- [x] 5.3 CLAUDE.md: update the write-tools section (preservation default + flag, section-on-body-or-refuse, set_frontmatter refusal), brief, matching existing style.
