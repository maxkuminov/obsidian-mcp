...
The `lstat` symlink/directory refusal still runs first and is deliberately not re-checked: a symlink swapped in afterwards is moved into `.trash` intact, never followed.
